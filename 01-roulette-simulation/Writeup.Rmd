...
<p>&emsp;Changing a parameter will change the simulation solution. As we set the one series player function, and stop running function, parameter are critical element. For the following scenario, we change the staring budget from $200 to $100</p>
