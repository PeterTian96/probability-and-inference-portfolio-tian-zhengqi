...
<p>&emsp; This loop allows us have a data set including 1000 plays' running times. To get the estimate avage ruing time, We can use mean function to find the average number: </p>
      mean(running_time)
