...
Here, one easy one is to use B + Q method to simulate the result.
```{r}
...
With the function, we can have catch the mean from coverage probability. After 1000 simulation, we can have the mean. We can find the result is over 0.95, which means that for 1000 invertal here, there are over 950 interval meet the confident interval in 95%.
